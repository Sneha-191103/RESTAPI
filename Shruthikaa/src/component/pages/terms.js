...
import NavAdmin from '../AdminAccess/navAdmin';
export default function Terms(){ 
    ...
    <div style={{padding:'30px 30px 30px 30px'}}>
        ...
        <div style={{color:'grey'}}>Last updated on September 23, 2023</div>
        <br></br><br></br>
        <h4>Acceptance of terms:</h4><div style={{paddingLeft:'30px'}}>
        <br></br>
        <p>
            Thank you for using Happy Tummy. These Terms of Service (the "Terms") are intended to make you aware of your legal rights and responsibilities with respect to your access to and use of the Happy Tummy website at www.Happy Tummy.com (the "Site") and any related mobile or software applications ("Happy Tummy Platform") including but not limited to delivery of information via the website whether existing now or in the future that link to the Terms (collectively, the "Services")
            <h4> Eligibility:</h4>   
        ...
        <br></br></div>
        <h4>Compliance of Law: </h4> <div style={{paddingLeft:'30px'}}>
        <br></br>
        <p>
        Both the User and the Food Delivery Platform must be in compliance with all laws and regulations in the country in which they live while accessing and using the Service. The User must agree to use the Services only in compliance with terms & conditions, applicable law, and in a manner that does not violate legal rights or those of any third party/parties.
        <h4>Legal implications of online food ordering: </h4>
        </p>
        <p>
       ...
       <br></br></div>
        <h4>TERMS OF SERVICE OF FDP:</h4><div style={{paddingLeft:'30px'}}>
        <br></br>
        <ul type='1'>
            <li>
            ...
            <br></br>
            <li>
            The FDP shall not be liable for any actions or omissions by the Restaurant Partners including deficiency in service, wrong delivery or order, quality of food, time is taken to prepare or deliver the order, etc. 
            </li><br></br>
            <li> The FDP must state that the liability of any violation of the Food Safety and Standards Act, 2006 and applicable rules and regulations made thereunder shall solely be towards the seller/owners, vendors, Restaurant Partners, importer or manufacturers of the food products. 
            </li><br></br>
            <li>
            ...
            <li>
            The acceptance by a Delivery Partner of undertaking delivery of User’s order shall constitute a contract of service under the Consumer Protection Act, 2019 or any successor legislation, between the User and the Delivery Partner, to which again food Delivery Platform is not a party. 
            </li><br></br>
            <li>
            The FDP must clarify that FDP does not provide any delivery or logistics services and only enables the delivery of food and beverages ordered by the Users through FDP by connecting User with Delivery Partners or the Restaurant Partners, as the case may be.
            </li><br></br>
            <li>
            The FDP must state that it will use reasonable efforts to inform the User of the Delivery Charges that may apply to the User, provided the User will be responsible for Delivery Charges incurred for User’s order regardless of User’s awareness of such Delivery Charges.
            </li><br></br>
            <li>
            The FDP shall reserve it’s right that at any time and without prior notice, the Food Delivery Platform can remove, block, or disable access to any Content, for any reason or no reason, considered to be objectionable, in violation of the terms and conditions of this Agreement or otherwise harmful to the Services.
            </li><br></br>
            <li>   Intellectual & Proprietary Rights: The Food Delivery Platform shall declare in the form of a clause its ownership of FDP content and Proprietary Rights in detail every user must agree to protect FDP’S IPR and proprietary rights.
            </li><br></br>
            <li>
            Use of License aspects: Food Delivery Platform shall grant User a personal, limited, non-exclusive, and non-transferrable license to access and use the Services only as expressly permitted as per the terms and conditions of the Agreement. The user shall  agree not to use the services for any illegal purpose or in any manner inconsistent with the terms and conditions of this Agreement
            </li><br></br>
            <li>
            ...
            <li>  Delivery periods/Pickup time quoted at the time of ordering are approximate only and may vary depending upon the situation.  When the User opts for Pickup at the time of placing the Order, and FDP shall not be liable in any manner in this regard. 
            </li><br></br> 
            <li>   Personal Promo Code/offers/memberships can be used by the User subject to such terms and conditions set forth by the Food Delivery Platform from time to time. The FDP can promote its new offers/membership plans etc. and the User will have to subscribe for the same. The subscribers will only be eligible for offers opted.
            </li> <br></br>
        </ul>
       <br></br></div>
        <h4>TERMS OF USE FOR CUSTOMER : </h4> <div style={{paddingLeft:'30px'}}>
        <br></br>   
        <ul>
            <li>The User shall request to order food and beverages from a Restaurant Partner by clicking on ‘Place Order’ tab on the Restaurant Partner page on the FDP shall constitute an unconditional and irrevocable authorization issued in favor of FDP to place online orders for food and beverages against the Restaurant Partners on User’s behalf. 
            An order, once placed on behalf of User by the FDP and accepted by a Restaurant Partner constitutes a separate contract of sale of goods under the Sale of Goods Act,1930 and the Consumer Protection Act, 2019 or any successor legislation between the Restaurant Partner and the User, to which the Food Delivery Platform shall not be a party. 
            </li><br></br><li>
            The User must warrant that while placing an order the details like contact number, delivery address, etc. are accurate and correct. By providing these details, the User expresses his/her acceptance of FDP’s terms and conditions and privacy policies. 
            </li><br></br><li>
            The User shall not resell food purchased via FDP. 
            </li><br></br><li>
            The User shall be charged a delivery fee for delivery of the order by the Delivery Partner or Restaurant Partner as the Delivery Partner or Restaurant Partner may determine (“Delivery Charges”). The User must agree that the Food Delivery Platform is authorized to collect, on behalf of the Delivery Partner or Restaurant Partner, as the case may be. The Delivery Charges may vary from, order to order, which may be determined on multiple factors such as order value, demand during peak hours, etc.
            </li><br></br>
        </ul>
        <br></br>
        <h4> CANCELLATION OF ORDER</h4>
        <br></br>
            <li>The User must acknowledge that any cancellation or attempted or purported cancellation of an Order shall amount to a breach of User’s unconditional and irrevocable authorization in favor of the Food Delivery Platform to place that Order against the Restaurant Partners on User’s behalf (“Authorization Breach”). 
            </li> 
            <li>
        ...
        <br></br></div>
        <h4> ACCOUNT REGISTRATION ON THE PLATFORM</h4> <div style={{paddingLeft:'30px'}}>

        <li>One shall have the access to the Platform by registering to create an account for the(Food Delivery Platform") and become a member; or shall be able register to himself join by logging into your account with certain third-party social networking sites (" SNS") (including, but not limited to, Facebook); each such account, a " Third Party Account", via our Platform.
        </li> <li>
         The Membership is limited for the purpose and are subject to the terms, and strictly not transferable. As part of the functionality of the Platform services, one shall be able to may link FDP   Account with Third-Party Accounts, by either:
        </li><li>
        Providing your Third Party Account login information to us through the Platform; or
        </li><li>
         Allowing us to access their Third-Party Account, as is permitted under the applicable terms and conditions that govern your use of each Third-Party Account.
        </li><li>
        The user shall represent that you are entitled to disclose your Third Party Account login information to us and/or grant the FDP access to your Third-Party Account (including, but not limited to, for use for the purposes described herein), without breach of any of the terms and conditions that govern your use of the applicable Third-Party Account and without obligating them to pay any fees or making us subject to any usage limitations imposed by such third-party service providers.
        </li><li>
        By granting us access to any Third Party Accounts, the Food Delivery Platform shall be able to access, make available and store (if applicable) any content or information that the user shall provide to and stored in your Third-Party Account so that it is available on and through the Platform via your Food Delivery Platform Account. Unless otherwise specified in these Terms of Use, all provided information if any will be considered to be your content for all purposes of these Terms of Use.
        </li><li>
        Depending on the Third-Party Accounts, the user shall choose, and subject to the privacy settings that the user has set in such Third-Party Account shall be personally identifiable information that you post to your Third-Party Accounts will be available on and through your Food Delivery Platform Account on the Platform.
        </li><li>
         Every user shall have access to only one FDP account and shall not be permitted to create multiple accounts. On finding multiple accounts of any user,   the FDP reserves the right to suspend such multiple accounts without being liable for any compensation.
        </li><li>
         Every user shall provide accurate, current and complete information during the registration process and to update such information to keep it accurate, current and complete.
        </li><li>
        The FDP shall   reserve the right to suspend or terminate your Food Delivery Platform Account and your access to the Services in the event ;
        </li>
        <ol type='i' style={{paddingLeft:'50px'}}>
           <li> if any information provided during the registration process or thereafter proves to be inaccurate, not current or incomplete; 
            ...
            if it is believed that a user’s actions may cause legal liability for the Food Delivery Platform or the user; or for both.
            </li> <li>
            if the user is found to be non- compliant with the Terms of Use.
            </li> 
        </ol>
        ...
        <h4>PAYMENTS & REFUNDS</h4><div style={{paddingLeft:'30px'}}>
        <br></br>
        <h5>Refunds</h5>
        <br></br>
            <li>The user  shall be entitled to a refund only if you pre-pay for your order at the time of placing your order on the Platform and only in the event of any of the following circumstances:
            </li>
            <ol style={{paddingLeft:'50px'}} type='1'>
                <li>   The  order packaging has been tampered or damaged at the time of delivery</li> 

                <li> The user cancels the order due to: </li>
                <ol style={{paddingLeft:'40px'}} type='a'>
            ...
            <li> The decision on refunds shall be at the sole discretion of the Food Delivery Platform and shall be final and binding.
            </li>
            <li>All refund amounts shall be credited to your account within 3-4 business days in accordance with the terms that may be stipulated by the bank which has issued the credit/debit card.
            </li>
        <br></br></div>
        <h5>PAYMENTS: </h5><div style={{paddingLeft:'30px'}}>
        <br></br>
        <li>In case of payment at the time of delivery, the user shall not be required to pay for:</li>
        ...
        Such as Interpretation, Waiver, Entire Agreement, Severability, Partnership Agency, etc. Governing Law, Jurisdiction, Dispute Resolution, etc. shall form part of this Agreement.
            ...
            <br></br></div>
        <h4>Contact Us:</h4><div style={{paddingLeft:'30px'}}>
        <br></br>
        <li>Details of the Company
        Legal Entity Name: Happy Tummy Limited (formerly known as Happy Tummy Private Limited and Happy Tummy Media Private Limited)
        </li>
        <br></br>
        <div>
        <b><div>Registered Address: Sri krishna College of Technology,Arivoli Nagar,Kovaipudur,Coimbatore-641042</div>
       <div> Corporate Address: Sri krishna College of Technology,Arivoli Nagar,Kovaipudur,Coimbatore-641042</div>
        <div>Details of website and Application: www.Happy Tummy.com (“Website”) and “Happy Tummy ” application </div>
        <div>Contact Details: info@Happy Tummy.com</div></b>
        </div>
        </div>
    </div><Footer/> 
        </>
