...
export default function Privacy(){
    return(
        ...
        <div style={{padding:'20px 20px 20px 20px'}}>
            <div className="privacy" style={{padding:'20px 20px 20px 20px'}}>
            <h3>PRIVACY POLICY</h3>
            <br></br>
            <div style={{paddingLeft:'40px'}}>
            <p><b>Happy Tummy </b>(Formerly known as Happy Tummy and Happy Tummy Media Private Limited) and/or its affiliates ("Happy Tummy," the "Company," "we," "us," and "our,") respect your privacy and is committed to protecting it through its compliance with its privacy policies. 
            <br></br>
            This policy describes:</p>
            <p>
            the types of information that <b>Happy Tummy</b> may collect from you when you access or use its websites, applications and other online services (collectively, referred as "Services"); and
            its practices for collecting, using, maintaining, protecting and disclosing that information.
            This policy applies only to the information Happy Tummy collects through its Services, in email, text and other electronic communications sent through or in connection with its Services.
            </p>
            <br></br>
            <p>
            This policy DOES NOT apply to information that you provide to, or that is collected by, any third-party, such as restaurants at which you make reservations and/or pay through Happy Tummy's Services and social networks that you use in connection with its Services. Happy Tummy encourages you to consult directly with such third-parties about their privacy practices.
            </p>
            <br></br>
            <p>
            Please read this policy carefully to understand <b>Happy Tummy</b> policies and practices regarding your information and how Happy Tummy will treat it. By accessing or using its Services and/or registering for an account with Happy Tummy you agree to this privacy policy and you are consenting to Happy Tummy's collection, use, disclosure, retention, and protection of your personal information as described here. If you do not provide the information Happy Tummy requires, Happy Tummy may not be able to provide all of its Services to you.
            </p>
            <br></br>
            <p>
            The information we collect and how we use it
            Zomato Limited ("Happy Tummy," the "Company," "we," "us," and "our”) collects several types of information from and about users of our Services, including:
            </p>
            <br></br>
            <p>
            ...
            Applications: If you use the Happy Tummy application, Happy Tummy may collect information about the presence and/ or absence and/ or details pertaining to other applications on your mobile phone. The applications we gather information for, may vary across categories including, without limitation, shopping, fashion, food and travel. This will help us understand you and your preferences better and enable Happy Tummy to provide you with a personalized experience.
            ...
            If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of Happy Tummy, our customers or others. This includes exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction.
            ...
            When you sign up for an account, you are opting in to receive emails from other <b>Happy Tummy</b> users, businesses, and <b>Happy Tummy</b> itself. You can log in to manage your email preferences and follow the "unsubscribe" instructions in commercial email messages, but note that you cannot opt out of receiving certain administrative policy, service policy, or legal policy from <b>Happy Tummy</b>.
            </p>
            <br></br>
            <p>
            Reviewing, changing or deleting information
            If you would like to review, change or delete personal information we have collected from you, or permanently delete your account, please use the "Contact Us" link at the bottom of every page (also located here), or contact the <b>Happy Tummy</b> Data Protection Officer (DPO).
            </p>
            <br></br>
            <p>
            ...
            Right to data portability of the Personal Information supplied to <b>Happy Tummy</b> by the EU resident
            Right to object (opt-out) to processing (unless happy tummy otherwise has compelling legitimate grounds)
            EU residents can exercise these rights by raising a request directly at privacy@happytummy.com or contact us at the information provided in CONTACT US section.
            </p>
            <br></br>
            <p>
            ...
            If you have any queries relating to the processing/ usage of information provided by you or <b>Happy Tummy's</b> Privacy Policy, you may email the Data Protection Officer (DPO) at privacy@happytummy.com or write to us at the following address.
            </p>
            <br></br>
            <p><b>
            <div>For Users residing in Coimbatore:</div>
            <div>Happy Tummy limited,Perur,Coimbatore.</div>
            <div>For Users residing in the Nilgiris:</div>
            <div>Happy Tummy limited,Manjoor, Nilgiris.</div></b>
            </p></div>
